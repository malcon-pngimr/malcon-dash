...
### Number output `r round(province_complete/22*100, 2)`

```{r}
### Success Rate
round(province_complete/22*100, 2)
```

### Survey Progress {.gauge}
```{r}
### Success Rate
gauge(
...
```{r}
rnaturalearth::ne_states(country = "Papua New Guinea", returnclass = "sf") %>%
