...
hfc_v3 <- read.csv(paste0("https://", pat_key, "@", url_data_old, fid[1], ".csv"))
pi_v3 <- read.csv(paste0("https://", pat_key, "@", url_data_old, fid[2], ".csv"))
ppa_v3 <- read.csv(paste0("https://", pat_key, "@", url_data_old, fid[3], ".csv"))
ei_v3 <- read.csv(paste0("https://", pat_key, "@", url_data_old, fid[4], ".csv"))
fvs_v1 <- read.csv(paste0("https://", pat_key, "@", url_data_old, fid[5], ".csv"))
